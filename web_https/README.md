...
But it ended up being this WEB Server, it's easier to use and I can load it up anywhere on my local network (or extended LAN if using VPN like tailsca I use it and it works totally fine), I don't need to have it on my computer.
