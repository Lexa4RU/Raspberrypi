...
I started with Flask to host the templates since I already used it for a school project, and I didn't knew how to do backend with any other solutions and for the scale of the project it's totally fine, since I'm the only one user at this point. (Myabe I could make a multi-user version with not only my data but other people too, we never know)
